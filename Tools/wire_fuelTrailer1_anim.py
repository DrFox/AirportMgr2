"""Authors ABP_FuelTrailer1's AnimGraph, and reads it back to prove it.

  python Tools/wire_fuelTrailer1_anim.py            # wires, compiles, saves, verifies
  python Tools/wire_fuelTrailer1_anim.py --verify   # verifies only, changes nothing
...
SIGN: -1.0, matching every rolling bone in the fleet.
...
BP_PATH = "/Game/Vehicles/FuelTrailer1/ABP_FuelTrailer1"
BP = {"refPath": "%s.ABP_FuelTrailer1" % BP_PATH}
GRAPH = {"refPath": "%s.ABP_FuelTrailer1:AnimGraph" % BP_PATH}
    ...
    try:
        session, _ = Mcp.post({
            ...
            "params": {"protocolVersion": "2025-03-26", "capabilities": {},
                       "clientInfo": {"name": "wire_fuelTrailer1_anim", "version": "1"}},
        })
