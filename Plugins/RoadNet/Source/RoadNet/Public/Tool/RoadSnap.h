 ...
 */
struct ROADNET_API IRoadSnapRule
{
...
struct ROADNET_API FRoadNodeSnapRule final : public IRoadSnapRule
{
	virtual bool Resolve(const URoadNetwork& Network, const FVector2D& Cursor,
 ...
 */
struct ROADNET_API FRoadSegmentSnapRule final : public IRoadSnapRule
{
	virtual bool Resolve(const URoadNetwork& Network, const FVector2D& Cursor,
		const FRoadSnapSettings& Settings, FRoadSnapResult& Out) const override;
};
 ...
 */
class ROADNET_API FRoadSnapChain
{
public:
