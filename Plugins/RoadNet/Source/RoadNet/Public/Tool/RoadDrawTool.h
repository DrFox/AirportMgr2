 ...
 */
struct ROADNET_API IRoadDrawState
{
...
class ROADNET_API FRoadIdleState : public IRoadDrawState
{
public:
 ...
 */
class ROADNET_API FRoadChainingState : public IRoadDrawState
{
public:
 ...
 */
class ROADNET_API FRoadDrawTool : public IBuildTool
{
public:
	FRoadDrawTool();
