...
namespace GuidelineGeom
{
	 ...
	 * curve.
	 */
	ROADNET_API double ParamAtSample(int32 Index, double Fraction, int32 Count);
	 ...
	 */
	ROADNET_API bool PointAtDistance(
