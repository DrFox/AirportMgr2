...
public:
	...
	/**
	 * The chainlink fence's �60 mm line post. Base-centred, 245 cm tall, 1 unit = 1 cm once
	...
	/** The �90 mm corner and gate post - heavier instead of braced (README "Not here"). */
	UPROPERTY(EditAnywhere, Category = "Airside|Fence")
