 ...
 */
UCLASS()
class AIRSIDE_API ARoadJunctionGallery : public AActor
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Airside") double CellSpacing = 50000.0;
	 ...
	 */
	UPROPERTY(EditAnywhere, Category = "Airside") double DebugLineThickness = 120.0;

	/** Draw the solver's debug lines on top of the solid surface. */
	UPROPERTY(EditAnywhere, Category = "Airside") bool bDrawDebugLines = true;
