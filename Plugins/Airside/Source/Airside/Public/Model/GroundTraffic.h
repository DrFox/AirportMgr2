...
public:
	 ...
	 * meet would put a jump in the polyline). The old goal node's claim is released and the new
	 * goal's claimed, exactly as RedirectAgent does.
	 * ENFORCED BY: Airside.Model.Traffic.ExtendRouteKeepsMoving
	 */
