...
// THE AIRFRAME PHYSICS BUNDLE, split out of Model/RoadEntity.h by #176. Ground, climb,
// approach, engine and gear performance, wheelbase and steer law - everything FRouteFollower,
// FLandingRun, FTakeoffRun and FSpeedProfile need to fly or drive one aeroplane, and nothing
...
// anchor was.
//
// AirsideLog.h IS DELIBERATELY NOT INCLUDED HERE, since #176. FAirframe::EffectiveSteerLaw
...
/**
 * Logs, once per call, if Airframe cannot support its declared steer law - see
 * FAirframe::NeedsSteerLawWarning.
 *
 * A FREE FUNCTION DEFINED IN Airframe.cpp, not a member here, so this header can stay free
 ...
 */
AIRSIDE_API void WarnIfSteerLawUnsupported(const FAirframe& Airframe);
