...
USTRUCT()
struct AIRSIDE_API FRoadNodeId
{
	GENERATED_BODY()
...
USTRUCT()
struct AIRSIDE_API FRoadSegmentId
{
	GENERATED_BODY()
...
USTRUCT()
struct AIRSIDE_API FGuidelineNodeId
{
	GENERATED_BODY()
...
USTRUCT()
struct AIRSIDE_API FGuidelineEdgeId
{
	GENERATED_BODY()
...
USTRUCT()
struct AIRSIDE_API FEntityInstanceId
{
	GENERATED_BODY()
