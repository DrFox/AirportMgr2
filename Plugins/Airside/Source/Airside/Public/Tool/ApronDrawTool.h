 ...
 */
struct AIRSIDE_API IApronDrawState
{
...
class AIRSIDE_API FApronIdleState : public IApronDrawState
{
public:
 ...
 */
class AIRSIDE_API FApronOutliningState : public IApronDrawState
{
public:
 ...
 */
class AIRSIDE_API FApronDrawTool : public IBuildTool
{
public:
	FApronDrawTool();
