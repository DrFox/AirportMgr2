...
namespace
{
	FGuidelineNodeId StandOcc3Pose(const FTestAirport& A, FEntityInstanceId Stand)
	{
...
bool FStandRetargetTest::RunTest(const FString& Parameters)
{
	...
	const FEntityInstanceId Target = (Goal0 == StandOcc3Pose(A, A.Stands[0])) ? A.Stands[0] : A.Stands[1];
